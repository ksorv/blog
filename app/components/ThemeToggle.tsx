...
export const ThemeToggle: React.FC<{ className?: string }> = ({
  ...
  return (
    <button
      ...
      className={cx(
        'inline-flex h-14 scale-75 items-center justify-center overflow-hidden rounded-full p-1 focus:outline-none',
        'mt-auto mb-8 w-auto py-5 px-4 transition duration-200 md:mb-0 md:mt-0 md:w-14 md:p-1',
        className
      )}
    >
      <div className={cx('relative h-8 w-8')}>
        <span
          className="absolute inset-0 rotate-90 transform text-tertiary transition duration-1000 motion-reduce:duration-[0s] dark:rotate-0"
        ...
        <span
          className="absolute inset-0 rotate-0 transform text-saccent transition duration-1000 motion-reduce:duration-[0s] dark:-rotate-90"
          style={{ transformOrigin: '50% 100px' }}
        >
          <svg
            className="w-full text-tertiary"
      ...
      <span className="not-sr-only ml-4 block text-xl capitalize md:sr-only">
