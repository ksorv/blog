...
description: Here comes the next post filed under courses tag, In this I write
  about CSS layouts, Flexbox, And general CSS properties. Get in and Let it
  sink!
heroImage: /images/posts/css3.jpeg
date: 2024-06-10
tags:
  - blog
  - courses
...
After reading this, you'll know enough CSS to create any layout you want.
...
I'll end this post with it, As this post is just meant for beginners.
